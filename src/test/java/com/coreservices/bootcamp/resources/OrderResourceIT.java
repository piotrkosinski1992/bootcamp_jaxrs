...
public class OrderResourceIT {
	...
	public void getOrdersTest() {
		...
		RestAssured.given().when().get(ORDERS_URL).then().body(containsString("clientId"))
    ...
    public void getAVGPriceOfOrdersTest() throws IOException {
    	...
    	Assert.assertTrue(response.getStatusCode() == 200);
    	Assert.assertTrue(responseMessage.toString().contains("Average price of order based of all orders stored into database equals:"));
    }
}
